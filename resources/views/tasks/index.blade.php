        ...
        <div class="tasks-workspace">
            <section class="tasks-toolbar">
                ...
                <div class="justify-self-center inline-flex items-center rounded-xl border border-slate-200 bg-white p-1">
                    <button type="button" class="rounded-lg px-3 py-1.5 text-sm font-semibold" :class="workType==='triage' ? 'bg-slate-900 text-white' : 'text-slate-600'" @click="setWorkType('triage')">Triage</button>
