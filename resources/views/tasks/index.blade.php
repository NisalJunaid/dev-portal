<x-app-layout>
    ...
    <div x-data="taskWorkspace({ initialView: @js($activeView), initialWorkType: @js($workType), initialFiltersOpen: false, boardColumns: @js(collect($kanbanColumns)->map(fn($label, $key) => ['key' => $key, 'label' => $label])->values()) })" x-init="init()" class="tasks-shell" @keydown.escape.window="closeDropdowns(); closeCreateTaskDrawer();">
