...
<div x-show="tasks.length > 0" class="overflow-x-auto rounded-3xl border border-slate-200 bg-white" :class="loading ? 'opacity-50' : 'opacity-100'"><div id="timeline-gantt" class="min-h-[34rem] min-w-[960px] p-4" data-timeline-chart></div></div>
</section>
</div>
<script>
