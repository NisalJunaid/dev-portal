...
<tr data-list-empty-row><td colspan="5" class="px-4 py-4 text-xs text-slate-400">Drop tasks here</td></tr>
@endif
...
<td class="whitespace-nowrap py-2 pl-1 pr-3 font-bold"><a data-list-ticket-no data-ticket-drawer-url="{{ route('tickets.drawer', $ticket) }}" href="{{ route('tickets.show', $ticket) }}">{{ $ticket->ticket_no }}</a></td>
